...
export PATH=/opt/gradle-8.0.1/bin:/Library/Java/JavaVirtualMachines/graalvm-ce-java17-22.3.1/Contents/Home/bin:/usr/local/go/bin:/opt/bin:/opt/homebrew/bin:/opt/pulumi:/opt/kafka/bin:/usr/local/opt/liquibase:$PATH
...
/usr/bin/ssh-add /Users/daidao/.ssh/finx_id_ed25519 > /dev/null 2>&1
